...
serverSocket.on("connect", (clientSocketOnServerSide) => {
  // serverSocket main circuit h  clientSocket ek user h

  console.log("server connected");

  clientSocketOnServerSide.on("chatJoin", ({ dummyData }) => {
    ...
    const msgForBroadcast =
      "Goes to everyone except the sender and the new socket ";
